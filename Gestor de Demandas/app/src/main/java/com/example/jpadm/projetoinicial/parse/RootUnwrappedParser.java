 ...
 */
public class RootUnwrappedParser<T> implements Parser {
    ...
    @Override
    public Object parse(String jsonContent) throws JsonParseException, JsonMappingException, IOException {
        return null;
    }

    @Override
    public Object parse(InputStream jsonContent) throws JsonParseException, JsonMappingException, IOException {
